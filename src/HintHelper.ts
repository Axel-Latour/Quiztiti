...
/**
 * Update the given question object when generating the hint.
 * Hint is generated by displaying 25% of the answer when this function is called.
...
export const fillSecretsWithLetters = (question: Question) => {
  ...
  // Returns a number between 1 and alphanumeric characters length (to avoid counting spaces or separators)
  ...
  for (let i = 0; i < numberOfHints; i++) {
    ...
    randomIndex = Math.floor(Math.random() * (indexesToFill.length - 1));
